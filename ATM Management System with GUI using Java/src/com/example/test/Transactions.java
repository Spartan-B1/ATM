...
public class Transactions {
    public Transactions(Database database, int userID){
        ...
        String[][] data = TransactionsDatabase.getUserTransaction(database, userID);
    ...
    private static JTable jTable(String[][] data, String[] columnNames){
        ...
        table.getTableHeader().setBorder(BorderFactory.createMatteBorder(2, 2, 1, 2, GUIConstants.mainColor));
        table.setBorder(BorderFactory.createMatteBorder(1, 2, 2,2, GUIConstants.mainColor));
